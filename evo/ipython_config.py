...
#
#  Provides configurables for loading extensions and executing source as part of
...
## List of source to run at IPython startup.
...
## Should variables loaded at startup (by startup source, exec_lines, etc.) be
...
## Whether to install the default config source into the profile dir. If a new
#  profile is being created, and IPython contains config source for that profile,
#  then they will be staged into the new directory.  Otherwise, default config
#  source will be automatically generated.
...
## Whether to overwrite existing config source when copying
...
## Start IPython quickly by skipping the loading of config source.
