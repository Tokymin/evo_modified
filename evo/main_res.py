...
"""
main executable for viewing result source from the trajectory metric apps
...
def parser() -> argparse.ArgumentParser:
    basic_desc = "tool for processing one or multiple result source"
    lic = "(c) evo authors"
    ...
    main_parser.add_argument("result_files",
                             help="one or multiple result source", nargs='+')
