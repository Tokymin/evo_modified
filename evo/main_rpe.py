...
def parser() -> argparse.ArgumentParser:
    ...
    output_opts.add_argument("--save_plot", default="",
    ...
    kitti_parser = sub_parsers.add_parser(
        ...
        description="{} for KITTI pose source - {}".format(basic_desc, lic))
    ...
    tum_parser = sub_parsers.add_parser(
        ...
        description="{} for TUM trajectory source - {}".format(basic_desc, lic))
    ...
    euroc_parser = sub_parsers.add_parser(
        ...
        description="{} for EuRoC MAV source - {}".format(basic_desc, lic))
    ...
    bag_parser = sub_parsers.add_parser(
        ...
        description="{} for ROS bag source - {}".format(basic_desc, lic))
